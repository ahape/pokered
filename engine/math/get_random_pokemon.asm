; Gets a random value between 0-255 (inclusive) to use as a Pokemon ID
; Checks to see if that value is an illegal Pokemon ID
; If yes, then does tail recursion
; If no, then sets `e` as that value
GetRandomPokemon_::
	call Random
